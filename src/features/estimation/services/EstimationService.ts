...
export const getEstimationVariableDefinitions = (
  ...
  return [
    { token: 'projekt_id', aliases: ['projectId'], value: project.id || estimation.projectId || '' },
    ...
    { token: 'nr', aliases: ['numer', 'estimationNumber', 'orderNumber'], value: project.code || '' },
    { token: 'tytul', aliases: ['tytuł', 'title'], value: project.name || '' },
    { token: 'data', aliases: ['dzis', 'today'], value: resolvedDate },
    { token: 'produkty', aliases: ['items'], value: activeItemNames.join(', ') || itemNames.join(', ') },
    { token: 'pozycje_wyceny', aliases: ['estimationItems'], value: itemNames.join(', ') },
    { token: 'liczba_pozycji', aliases: ['itemsCount'], value: String(estimation.items.length) },
    { token: 'liczba_pozycji_aktywnych', aliases: ['activeItemsCount'], value: String(activeItemNames.length) },
    { token: 'suma_godzin', aliases: ['totalHours'], value: formatNullableNumber(totalHours) },
    { token: 'suma_godzin_bazowych', aliases: ['totalBaseHours'], value: formatNullableNumber(totalBaseHours) },
    { token: 'oczekiwane_godziny', aliases: ['expectedHours'], value: formatNullableNumber(estimation.expectedHours) },
    { token: 'wartosc_netto', aliases: ['netValue', 'estimationNetValue'], value: formatCurrencyValue(totalNetValue) },
    { token: 'wartosc_brutto', aliases: ['grossValue', 'estimationGrossValue'], value: formatCurrencyValue(totalGrossValue) },
    { token: 'wartosc_netto_slownie', aliases: ['netValueWords', 'estimationNetValueWords'], value: formatCurrencyAmountInWords(formatCurrencyValue(totalNetValue)) },
    { token: 'wartosc_brutto_slownie', aliases: ['grossValueWords', 'estimationGrossValueWords'], value: formatCurrencyAmountInWords(formatCurrencyValue(totalGrossValue)) },
    { token: 'tryb_harmonogramu', aliases: ['scheduleMode'], value: estimation.scheduleMode === 'simple' ? 'prosty' : 'kamienie milowe' },
    { token: 'data_realizacji_od', aliases: ['scheduleFrom'], value: simpleStart },
    { token: 'data_realizacji_do', aliases: ['scheduleTo'], value: simpleEnd },
    { token: 'kamienie_milowe', aliases: ['milestones'], value: milestoneNames.join(', ') },
    { token: 'kamienie_milowe_terminy', aliases: ['milestoneDates'], value: milestoneDates.join(', ') },
  ];
};
